rawdata = LOAD 'wasb://sources@pigteststorage.blob.core.windows.net/simple_dataset.csv' USING PigStorage(',') AS (dateP: chararray, webSession: chararray, cookie: chararray, sales: float);
